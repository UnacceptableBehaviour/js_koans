...
test("self invoking functions", function() {
    ...
    // TODO common use of self invoking functions
    (function(pv) {
        ...
        equal("string", typeof(publicValue), "is publicValue available in this context?"); // yes part of the function() closure
    })(publicValue);
...
test("arguments array", function() {
    var add = function() { // TODO - exersize w/ arguments
        var total = 0;
