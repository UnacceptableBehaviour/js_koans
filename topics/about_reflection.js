...
B.prototype = new A();  // {bprop: "B"} --->  {aprop: "A"} ---> Object.prototype ---> null
...
test("hasOwnProperty", function() {
    ...
    // {bprop: "B"} --->  {aprop: "A"} ---> Object.prototype ---> null // NOTE order
...
test("constructor property", function () {
    ...
    // TODO A? really? not going with B? WHY 
});
