...
test("'this' set explicitly", function () {
	...
	var message = person.intro.call({name: "Frank"});  	// TODO - pure guesswork
														// curly braces in call?
	// functionClass.call(this, args) func = person.intro .call( this = {name: "Frank"} , args = none)
